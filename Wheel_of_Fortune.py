...
class WOFHumanPlayer(WOFPlayer):
    ...
    def getMove(self,category,obscuredPhrase,guessed):
        ...
        print()
        print("Category: {}\nPhrase: {}\nGuessed: {}\n ".format(category,obscuredPhrase,guessed))
...
class WOFComputerPlayer(WOFPlayer):
    ...
    def getPossibleLetters(self,guessed):
        ...
        for a in LETTERS:
            if a not in guessed:
                if a in 'AEIOU' and self.prizeMoney>=VOWEL_COST:
                    lst.append(a)
                elif a not in 'AEIOU':
                    lst.append(a)
        return lst
    ...
    def getMove(self,category,obscuredPhrase,guessed):
        ...
        if self.smartCoinFlip()=="good":
            return [high for high in WOFComputerPlayer.SORTED_FREQUENCIES[::-1] if high in lst]
        else:   
